...
namespace iCARS.admin
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        *              will return the data in the data field selected.
        *****************************************************************************/
        protected string _getCategoryField(int nIndex, int nField)
        {
            SqlConnection scConn = new SqlConnection(szConnectionString);
            SqlCommand scStatement = new SqlCommand(String.Format("select * from category where id='{0}'", nIndex), scConn);
       ...
       *****************************************************************************/
         ...
         * Returns: (int) -1 if it fails, 0 if it succeeds.
         *****************************************************************************/
        protected int _editCategory(int ID, string szName, int nBrandID)
        {
            /////////////////////////////
            ////////////////////////////////////
            //////////////////////////////////////////////////////error
            ////////////////////////////////////////
            SqlConnection scConn = new SqlConnection(szConnectionString);
            SqlCommand scStatement = new SqlCommand("UPDATE category SET name=@catNAME, brand_id=@BrandID WHERE id=@ID", scConn);

            scStatement.Parameters.AddWithValue("@catNAME", szName);
            scStatement.Parameters.AddWithValue("@BrandID", nBrandID.ToString());
        ...
        *****************************************************************************/
        ...
        protected void _displayCategoryPage()
        {
            ...
            {
                SqlConnection scConn = new SqlConnection(szConnectionString);
                SqlCommand scStatement = new SqlCommand("SELECT * from category order by brand_id", scConn);
                ...
                try
                {
                    ...
                    while (sdr.Read())
                    {
                        ...
                        szPage += "      <td class=\"lite\">" + sdr[0].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[1].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[2].ToString() + " (" + _getBrandField(Convert.ToInt32(sdr[2].ToString()), 1) + ")</td>\n";
            ...
            if (adAUTH == "1")
            {
                ...
                szPage += "         <tr>\n";
                szPage += "            <td style=\"text-align: right; width: 40%;\"></td>\n";
                szPage += "            <td style=\"text-align: left; width: 60%;\"><div style=\"width: 301px; text-align: right;\"><input style=\"width: 100px;\" id=\"btnAddCat\" name=\"submit\" type=\"submit\" value=\"Add Category\" /></div></td>\n";
                szPage += "         </tr>\n";
                szPage += "      </table>\n";
                szPage += "      </td>\n";
                szPage += "   </tr>\n";
        ...
        protected void _displayItemPage()
        {
            ...
            szPage += "      <td class=\"dark\">Name</td>\n";
            szPage += "      <td class=\"dark\">Description</td>\n";
            szPage += "      <td class=\"dark\">Price</td>\n";
            szPage += "      <td class=\"dark\">Cat ID (Name)</td>\n";
            szPage += "      <td class=\"dark\">Length</td>\n";
            szPage += "      <td class=\"dark\">Width</td>\n";
            szPage += "      <td class=\"dark\">Weight</td>\n";
            szPage += "      <td class=\"dark\">Shipping Info</td>\n";
            szPage += "      <td class=\"dark\"></td>\n";
            szPage += "   </tr>\n";
            ...
            {
                SqlConnection scConn = new SqlConnection(szConnectionString);
                SqlCommand scStatement = new SqlCommand("SELECT * from item", scConn);
                ...
                try
                {
                    ...
                    while (sdr.Read())
                    {
                        ...
                        szPage += "      <td class=\"lite\">" + sdr[2].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[3].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[4].ToString() + " (" + _getCategoryField(Convert.ToInt32(sdr[4].ToString()), 1) + ")</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[5].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[6].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[7].ToString() + "</td>\n";
                        szPage += "      <td class=\"lite\">" + sdr[8].ToString() + "</td>\n";
                        ...
                        if (nADType == 0) // Moderators can edit but not delete
                        {
                            szPage += "      <td class=\"lite\"><a href=\"default.aspx?pid=item&act=edit&id=" + sdr[0].ToString() + "\">EDIT</a></td>\n";
                        }
                        else
                        {
                            szPage += "      <td class=\"lite\"><a href=\"default.aspx?pid=item&act=edit&id=" + sdr[0].ToString() + "\">EDIT</a> | <a href=\"default.aspx?pid=item&act=delete&id=" + sdr[0].ToString() + "\">DELETE</a></td>\n";
                        }
            ...
            if (adAUTH == "1")
            {
                ...
                szPage += "               <td style=\"text-align: left; width: 60%;\"><input style=\"width: 300px;\" id=\"iWidth\" name=\"iWidth\" type=\"text\" /></td>\n";
                szPage += "            </tr>\n";
                szPage += "            <tr>\n";
                szPage += "               <td style=\"text-align: right; width: 40%;\">Item Weight:&nbsp;</td>\n";
                szPage += "               <td style=\"text-align: left; width: 60%;\"><input style=\"width: 300px;\" id=\"iWeight\" name=\"iWeight\" type=\"text\" /></td>\n";
                szPage += "            </tr>\n";
                szPage += "            <tr>\n";
                                ...
                                if (Request.QueryString["act"] != null)
                                {
                                    ...
                                    if (szACT == "edit")
                                    {
                                        if (Request.QueryString["id"] != null)
                                        {
                                            if (int.TryParse(Request.QueryString["id"].ToString(), out int nIndex))
                                            {
                                                string szName = _getCategoryField(nIndex, 1);
                                                string szBrandID = _getCategoryField(nIndex, 2);
                                                ...
                                                szPage += "   <tr style=\"font-weight: bold; text-decoration: underline;\">\n";
                                                szPage += "      <td class=\"dark\">\n";
                                                szPage += "         <h1>EDIT CATEGORY</h1>\n";
                                                szPage += "         <br />\n";
                                                szPage += "         <table style=\"margin: auto; width: 100 %;\">\n";
                                                szPage += "            <tr>\n";
                                                szPage += "               <td style=\"text-align: right; width: 40%;\">Category Name:&nbsp;</td>\n";
                                                szPage += "               <td style=\"text-align: left; width: 60%;\"><input style=\"width: 300px;\" id=\"catName\" name=\"catName\" type=\"text\" value=\"" + szName + "\" /></td>\n";
                                                szPage += "            </tr>\n";
                                                ...
                                                try
                                                {
                                                    ...
                                                    szPage += "   <tr>\n";
                                                    szPage += "      <td style=\"text-align: right; width: 40%;\">Brand:&nbsp;</td>\n";
                                                    szPage += "      <td style=\"text-align: left; width: 60%;\">\n";
                                                    szPage += "         <select id=\"bid\" name=\"bid\">\n";
                                                    while (sdr.Read())
                                                    {
                                                        if (sdr[1].ToString() == _getBrandField(Convert.ToInt32(szBrandID), 1))
                                                        {
                                                            szPage += "            <option value=\"" + sdr[1].ToString() + "\" selected>" + sdr[1].ToString() + "</option>\n";
                                                        }
                                                        else
                                                        {
                                                            szPage += "            <option value=\"" + sdr[1].ToString() + "\">" + sdr[1].ToString() + "</option>\n";
                                                ...
                                                szPage += "            <tr>\n";
                                                szPage += "               <td style=\"text-align: right; width: 40%;\">All changes are final once you click 'Edit Category'!</td>\n";
                                                szPage += "               <td style=\"text-align: left; width: 60%;\"><div style=\"width: 301px; text-align: right;\"><input style=\"width: 100px;\" id=\"btnEditBrand\" name=\"submit\" type=\"submit\" value=\"Edit Brand\" /></div></td>\n";
                                                szPage += "            </tr>\n";
                                                szPage += "         </table>\n";
                                                szPage += "      </td>\n";
                                    ...
                                    else if (szACT == "delete")
                                    {
                                        if (Request.QueryString["id"] != null)
                                        {
                                            if (int.TryParse(Request.QueryString["id"].ToString(), out int nIndex))
                                            {
                                                ...
                                                szPage += "   <tr style=\"font-weight: bold; text-decoration: none;\">\n";
                                                szPage += "      <td class=\"dark\">\n";
                                                szPage += "         <h1>DELETE CATEGORY</h1>\n";
                                                szPage += "         <br />\n";
                                                szPage += "         <table style=\"margin: auto; width: 100 %;\">\n";
                                                szPage += "            <tr>\n";
                                                szPage += "               <td style=\"text-align: left; width: 60%;\">Are you sure you want to delete '" + _getCategoryField(nIndex, 1) + "'?:&nbsp;&nbsp;<input style=\"width: 100px;\" id=\"btnDeleteCategory\" name=\"submit\" type=\"submit\" value=\"Delete\" /></td>\n";
                                                szPage += "            </tr>\n";
                                                szPage += "         </table>\n";
                                                szPage += "      </td>\n";
                                                szPage += "   </tr>\n";
                    ...
                    if (Request.Form["act"].Length > 0)
                    {
                        ...
                        if (szAct == "add")
                        {
                            ...
                            if (nErrFound == 0)
                            {
                                ...
                                if (nErrFound == 1)
                                {
                                    _content.InnerHtml = szPage + "<hr style=\"width: 300px;\"/><a href=\"default.aspx?pid=category\" style=\"text-decoration: underline;\">Click here</a> to go back.</div>";
                                }
                                else
                                {
                                    // Add the admin, if a error occurs adding the admin then we let the end-user know an error has occurred.
                            ...
                            {
                                _content.InnerHtml = "<div style=\"text-align: center;\">An unknown error has occurred!<a href=\"default.aspx?pid=category\" style=\"text-decoration: underline;\">Click here</a> to go back.</div>";
                            }
                        }
                        ...
                        else if (szAct == "edit")
                        {
                            if (Request.Form["id"] != null)
                            {
                                ...
                                if (nErrFound == 0)
                                {
                                    ...
                                    if (nErrFound == 1)
                                    {
                                        _content.InnerHtml = szPage + "<hr style=\"width: 300px;\"/><a href=\"default.aspx?pid=category&act=edit&id=" + Request.QueryString["id"] + "\" style=\"text-decoration: underline;\">Click here</a> to go back.</div>";
                                    }
                                    ...
                                    if (int.TryParse(Request.Form["id"].ToString(), out int nIndex))
                                    {
                                        ...
                                        {
                                            _content.InnerHtml = "<div style=\"text-align: center;\">Error: " + szLastErrorMessage + "<a href=\"default.aspx?pid=category&act=edit&id=" + nIndex.ToString() + "\" style=\"text-decoration: underline;\">Click here</a> to go back.</div>";
                                        }
                                    }
                                    else
                                    {
                                        _content.InnerHtml = "<div style=\"text-align: center;\">An unknown error has occurred!<a href=\"default.aspx?pid=category&act=edit&id=" + nIndex.ToString() + "\" style=\"text-decoration: underline;\">Click here</a> to go back.</div>";
                                    }
